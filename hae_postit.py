                    ...
                    if isinstance(response_part, tuple):
                        ...
                        for mittariLukema in kaikkiLukemat:
                            ...
                            if mittariLukema.find(":") > -1:
                                ...
                                yhtionVesi = 0
                                if mittari.lower().find('yhtiönvesi') > -1:
                                    vastikeLukemat["yhtionmittarit"][raporttikausi]["vesimittari"] = int(lukema)

                                yhtionKaukolampo = 0                                  
                                if mittari.lower().find('kaukolämpö') > -1:
